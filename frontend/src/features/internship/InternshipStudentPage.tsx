...
import { Laptop, AlertTriangle, ExternalLink } from 'lucide-react';
...
export default function InternshipStudentPage() {
  ...
  const iframeUrl = appscriptId 
    ? `https://script.google.com/macros/s/${appscriptId.trim()}/exec?page=student_dashboard`
    : '';
    ...
    return (
      ...
      >
        ...
        <p className="text-secondary mb-4" style={{ maxWidth: '520px', fontSize: '14px', lineHeight: 1.6, margin: '0 auto 24px auto', fontWeight: 500 }}>
          ...
          Please configure the <strong>Google Sheets Apps Script Deployment ID</strong> in the server settings to access the student portal.
        </p>
        <div 
