...
function runDockerCompose(conn) {
  ...
  const composeCmd = [
    ...
    // 5. Restore rendered docker-compose file from user_config.yaml template
    `cp ${TRUENAS_CONFIG_DIR}/user_config.yaml ${TRUENAS_CONFIG_DIR}/templates/rendered/docker-compose.yaml`,
